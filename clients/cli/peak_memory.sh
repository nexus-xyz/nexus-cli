...
# This script measures the peak memory usage of the nexus-network binary.
...
echo "Starting nexus-network and monitoring memory for ${DURATION} seconds..."

# Start the process in background and capture its PID
./target/release/nexus-network start --headless &
PID=$!
